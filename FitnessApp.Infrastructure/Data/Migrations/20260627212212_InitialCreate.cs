        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedByAppUserId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoalWeightKg = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    Goal = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SetLogs_WorkoutSessionId_WorkoutExerciseId_SetNumber",
                table: "SetLogs",
                columns: new[] { "WorkoutSessionId", "WorkoutExerciseId", "SetNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workouts_FitnessProgramId_WeekNumber_DayNumber",
                table: "Workouts",
                columns: new[] { "FitnessProgramId", "WeekNumber", "DayNumber" });
